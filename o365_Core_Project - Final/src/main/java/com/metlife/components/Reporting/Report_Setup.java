...
import com.metlife.components.Utilities.Constants;
...
public class Report_Setup {
    ...
    static {
        ...
        extent = new ExtentReports(".\\src\\main\\resources\\com\\metlife\\components\\Results\\Graphical Reporting\\HTML\\" + filename, true);
    }
}
